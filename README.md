...
| Rate Limiting            | Implemented rate limiting on sensitive routes (e.g., login, password reset) to prevent brute force attacks                                                                                                                                                                                          | Verified by sending rapid repeated requests and observing 429 Too Many Requests responses                                      |
